...
/** @type {string} */
const CACHE_VERSION = '1762179613|37956930496';
/** @type {string} */
const CACHE_PREFIX = 'FlappyBirdGame-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'FlappyBirdGame.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = true;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["FlappyBirdGame.html","FlappyBirdGame.js","FlappyBirdGame.offline.html","FlappyBirdGame.icon.png","FlappyBirdGame.apple-touch-icon.png","FlappyBirdGame.audio.worklet.js","FlappyBirdGame.audio.position.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHEABLE_FILES = ["FlappyBirdGame.wasm","FlappyBirdGame.pck","FlappyBirdGame.side.wasm"];
